...
<head>
  ...
  <meta name="description" content="Encontre imóveis da CAIXA com descontos de até 90% em todo o Brasil. Filtre por estado, cidade, tipo, modalidade (leilão, licitação, venda direta e online) e condições de pagamento. Imobiliária parceira credenciada CRECI-SP 54306.">
  <meta property="og:title" content="Arremate Imóveis Online | Imóveis da CAIXA com Desconto em Todo o Brasil">
  <meta property="og:description" content="A plataforma mais completa para buscar imóveis da CAIXA. Filtros por estado, cidade, tipo, modalidade e desconto. Dados atualizados diariamente. Imobiliária parceira credenciada CRECI-SP 54306.">
...
#oportunidades .sec-inner{padding-bottom:16px!important}
#simulador .sec-inner{padding-top:16px!important}
...
.logo-sub{font-size:.72rem;color:rgba(255,255,255,.88);line-height:1.2;margin-top:4px}
.logo-sub-full{display:inline}
...
@media(max-width:900px){
  ...
  .logo-sub{white-space:normal;font-size:.71rem}
  ...
  #para-morar,#para-investir,#sobre{display:none!important}
...
.oport-more-wrap { margin-bottom: 40px; }
#simulador { margin-top: -20px; }
.btn-fav { position: absolute; top: 10px; right: 50px; background: rgba(255,255,255,0.9); border-radius: 50%; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; cursor: pointer; z-index: 20; box-shadow: 0 2px 5px rgba(0,0,0,0.2); border: none; }
.btn-fav.is-fav { color: #e11d48; }
</style>
</head>
<body>
...
<header class="site-header">
  ...
  <div class="hdr">
    <a href="index.php" class="logo">
      ...
      <div class="logo-txt">
        ...
        <div class="logo-sub">
          <span class="logo-sub-full">A maior plataforma de busca de imóveis da CAIXA do Brasil</span>
          <span class="logo-sub-mobile">Imóveis da CAIXA em todo o Brasil</span>
        </div>
      </div>
    </a>
    <nav class="nav-links" id="navDesktop">
      <a href="index.php#para-morar">Para morar</a>
      <a href="index.php#para-investir">Para investir</a>
      <a href="index.php#oportunidades">Oportunidades</a>
      <a href="resultados.html">Buscar Imóveis</a>
      <a href="favoritos.html">❤️ Favoritos</a>
      <a href="index.php#simulador">Simule</a>
      <a href="index.php#duvidas">Dúvidas</a>
      <a href="index.php#contato" class="btn-nav-cta">💬 Especialista</a>
    </nav>
  ...
  <nav class="nav-mobile">
    ...
    <a href="index.php#para-morar" onclick="document.getElementById('menu-toggle').checked=false">🏠 Para morar</a>
    <a href="index.php#para-investir" onclick="document.getElementById('menu-toggle').checked=false">📈 Para investir</a>
    ...
    <a href="index.php#simulador" onclick="document.getElementById('menu-toggle').checked=false">📊 Simule</a>
    <a href="index.php#duvidas" onclick="document.getElementById('menu-toggle').checked=false">❓ Dúvidas</a>
    <a href="index.php#contato" class="nav-mob-cta" onclick="document.getElementById('menu-toggle').checked=false">💬 Especialista</a>
  </nav>
</header>
...
<section class="hero">
  <div class="hero-inner">
    <div>
      ...
      <p class="hero-sub">Busque imóveis da CAIXA por estado, cidade, tipo e modalidade — leilão, licitação, venda online e venda direta. Encontre imóveis com até 90% de desconto sobre a avaliação antes que alguém mais chegue lá.</p>
      <div class="hero-badges">
        <span class="badge">🏠 Morar com desconto</span>
        <span class="badge">📈 Investir com inteligência</span>
        <span class="badge">🏦 Imobiliária parceira CRECI-SP 54306</span>
      </div>
      <div class="hero-stats">
        <div class="hero-stat"><strong>29.000+ imóveis</strong>cadastrados em todos os 27 estados</div>
        <div class="hero-stat"><strong>Até 90% OFF</strong>desconto real sobre o valor de avaliação</div>
        <div class="hero-stat"><strong>Atualizado diário</strong>dados direto do portal oficial da CAIXA</div>
      </div>
    </div>
    ...
    <div class="filter-card" id="busque-imoveis">
      ...
      <div class="filter-grid">
        ...
        <div class="filter-actions">
          ...
          <button class="btn-ghost" id="btnFiltros" type="button" onclick="abrirModal()">⚙️ Mais filtros</button>
        </div>
      </div>
      <p class="filter-note"><strong>Mais de 29.000 imóveis da CAIXA disponíveis.</strong> Use os filtros acima ou clique em <strong>Mais filtros</strong> para refinar por desconto, área, IPTU, condomínio e data de encerramento.</p>
    </div>
  </div>
</section>
...
<section class="sec-outer" id="sobre">
  <div class="sec-inner">
    ...
    <p class="sec-sub">A plataforma de busca de imóveis da CAIXA mais completa do Brasil. Simples, rápida e totalmente gratuita.</p>
    <div style="background:#fff;border:1px solid var(--borda);border-radius:var(--radius);padding:22px 26px;box-shadow:var(--sombra);font-size:.92rem;color:#334155;line-height:1.8">
      <p>O <strong>Arremate Imóveis Online</strong> é a plataforma ideal para quem quer buscar imóveis da CAIXA com inteligência. Reunimos mais de 29.000 imóveis disponíveis em todos os estados do Brasil — apartamentos, casas, terrenos, lotes e imóveis comerciais — com filtros avançados por cidade, tipo, modalidade, desconto e condições de pagamento como FGTS e financiamento.</p>
      <p style="margin-top:14px">Aqui você encontra imóveis de leilão CAIXA, licitação aberta, venda online e venda direta em um único lugar, com dados atualizados diariamente direto do portal oficial da CAIXA Econômica Federal. Sem cadastro, sem burocracia — só oportunidade.</p>
      <p style="margin-top:14px">📍 <strong>No Estado de São Paulo</strong>, contamos com uma <strong>imobiliária parceira credenciada junto à CAIXA</strong> (CRECI-SP 54306) para orientar e acompanhar você em cada etapa da compra, desde a busca até o fechamento do negócio.</p>
    </div>
  </div>
</section>

<!-- ===== PARA MORAR ===== -->
<section class="sec-outer alt" id="para-morar">
  <div class="sec-inner">
    <h2 class="sec-title">🏠 Imóveis da CAIXA para morar: encontre, filtre e compre com segurança</h2>
    <p class="sec-sub">Realize o sonho da casa própria pagando muito menos. Imóveis da CAIXA abaixo do valor de mercado, com possibilidade de FGTS e financiamento.</p>
    <div class="steps-grid">
      <div class="step-card">
        <div class="step-icon">🔎</div>
        <h3>Busque com filtros precisos</h3>
        <p>Filtre por estado, cidade, tipo de imóvel, modalidade e faixa de preço. Encontre em segundos o imóvel certo para o seu perfil e orçamento.</p>
      </div>
      <div class="step-card">
        <div class="step-icon">📄</div>
        <h3>Entenda a modalidade de venda</h3>
        <p>Leilão SFI, licitação aberta, venda online ou direta — cada uma tem regras diferentes. Explicamos tudo com clareza para você não errar na hora de comprar.</p>
      </div>
      <div class="step-card">
        <div class="step-icon">🏦</div>
        <h3>Use FGTS e financiamento</h3>
        <p>Muitos imóveis da CAIXA permitem financiamento e uso do FGTS. Identifique essas oportunidades direto nos filtros e simule sua parcela em segundos.</p>
      </div>
      <div class="step-card">
        <div class="step-icon">✅</div>
        <h3>Conte com nossa parceria em SP</h3>
        <p>Em São Paulo, nossa imobiliária parceira credenciada pela CAIXA (CRECI-SP 54306) acompanha você do primeiro filtro até as chaves na mão.</p>
      </div>
    </div>
  </div>
</section>
...
<!-- ===== PARA INVESTIR ===== -->
<section class="sec-outer" id="para-investir">
  <div class="sec-inner">
    <h2 class="sec-title">📈 Invista em imóveis da CAIXA: desconto real, oportunidade concreta</h2>
    <p class="sec-sub">Imóveis com descontos de até 90% sobre o valor de avaliação. Filtre, compare e identifique as melhores oportunidades de investimento em qualquer estado do Brasil.</p>
    <div class="steps-grid">
      <div class="step-card">
        <div class="step-icon orange">📉</div>
        <h3>Filtre por desconto e tipo</h3>
        <p>Use nosso filtro de desconto mínimo para encontrar imóveis com maior potencial de valorização. Compare o preço de venda com o valor de avaliação oficial e tome decisões com dados reais.</p>
      </div>
      <div class="step-card">
        <div class="step-icon orange">🛡️</div>
        <h3>Analise antes de avançar</h3>
        <p>Ocupação, IPTU, condomínio e documentação impactam o retorno. Nossa plataforma mostra esses dados quando disponíveis — você decide com mais segurança.</p>
      </div>
      <div class="step-card">
        <div class="step-icon orange">📊</div>
        <h3>Simule o cenário de compra</h3>
        <p>Use nosso simulador de financiamento para estimar parcelas, entrada e comprometimento de renda. Monte o cenário completo antes de fazer sua proposta.</p>
      </div>
      <div class="step-card">
        <div class="step-icon orange">🎯</div>
        <h3>Aja rápido nas melhores ofertas</h3>
        <p>Os melhores imóveis da CAIXA somem rápido. Com nossa plataforma atualizada diariamente, você chega primeiro às oportunidades com maior potencial de retorno.</p>
      </div>
    </div>
  </div>
</section>
...
<!-- ===== OPORTUNIDADES ===== -->
<section class="sec-outer alt" id="oportunidades">
...
<section class="sec-outer sim-bg" id="simulador">
  <div class="sec-inner" style="padding-top:12px">
    ...
    <div class="sim-wrap">
      ...
      <div class="sim-box">
        ...
        <p class="sim-note">Gostou de algum imóvel em SP? Nossa imobiliária parceira credenciada (CRECI-SP 54306) pode orientar sobre financiamento, FGTS e todo o processo de compra junto à CAIXA.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="sec-outer alt">
  <div class="sec-inner">
    ...
    <p class="sec-sub">Em menos de 2 minutos você encontra imóveis da CAIXA com desconto em qualquer estado do Brasil. Veja como é simples:</p>
    <div class="steps-grid">
      <div class="step-card">
        <div class="step-icon">🔎</div>
      ...
      <div class="step-card">
        ...
        <p>Para imóveis no Estado de São Paulo, nossa imobiliária parceira credenciada pela CAIXA (CRECI-SP 54306) está pronta para orientar você até o fechamento com total segurança.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="barra-inner">
    <div class="footer-cols">
      <div class="footer-col">
        ...
        <a href="index.php#para-morar">Para Morar</a>
        <a href="index.php#para-investir">Para Investir</a>
        <a href="index.php#simulador">Simulador de Financiamento</a>
        <a href="favoritos.html">❤️ Favoritos</a>
      </div>
      <div class="footer-col">
        <h4>Suporte</h4>
        ...
        <span style="color:#94a3b8">para imóveis da CAIXA em SP</span>
        <span style="color:#f39200;font-weight:700">CRECI-SP 54306</span>
      </div>
      <div class="footer-col">
        <h4>Contato</h4>
        ...
        <div class="footer-social">
          ...
          <a href="https://wa.me/5511999999999" title="WhatsApp" target="_blank" rel="noopener">💬</a>
        </div>
      </div>
    </div>
...
function buildCard(item) {
  ...
  creciText.textContent = 'CRECI: 54306';
  ...
  /* FAVORITAR + COMPARTILHAR (no thumb, canto superior) */
  var hdnFinal = hdn || (item.num_imovel || '').replace(/\D/g, '');
  var cardActions = document.createElement('div');
  cardActions.style.cssText = 'position:absolute;bottom:10px;right:10px;display:flex;gap:6px;z-index:15';
  
  var btnFavCard = document.createElement('button');
  btnFavCard.style.cssText = 'width:32px;height:32px;border-radius:50%;border:none;background:rgba(255,255,255,.9);cursor:pointer;font-size:1rem;display:flex;align-items:center;justify-content:center;box-shadow:0 2px 6px rgba(0,0,0,.2);transition:transform .15s';
  btnFavCard.textContent = isFavCard(hdnFinal) ? '💖' : '🤍';
  btnFavCard.title = 'Favoritar';
  btnFavCard.addEventListener('click', function(e) {
    e.preventDefault(); e.stopPropagation();
    if (isFavCard(hdnFinal)) { removeFavCard(hdnFinal); this.textContent = '🤍'; }
    else { addFavCard(hdnFinal); this.textContent = '💖'; }
  });
  
  var btnShareCard = document.createElement('button');
  btnShareCard.style.cssText = 'width:32px;height:32px;border-radius:50%;border:none;background:rgba(255,255,255,.9);cursor:pointer;font-size:.85rem;display:flex;align-items:center;justify-content:center;box-shadow:0 2px 6px rgba(0,0,0,.2)';
  btnShareCard.textContent = '📤';
  btnShareCard.title = 'Compartilhar';
  btnShareCard.addEventListener('click', function(e) {
    e.preventDefault(); e.stopPropagation();
    var shareUrl = hdnFinal ? window.location.origin + '/imovel.php?hdnimovel=' + hdnFinal : '#';
    ...
    else { navigator.clipboard.writeText(shareUrl).then(function(){ btnShareCard.textContent='✅';setTimeout(function(){btnShareCard.textContent='📤';},1500); }).catch(function(){ prompt('Copie:',shareUrl); }); }
  });
