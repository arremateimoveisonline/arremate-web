        ...
        <div class="panel">
          <div class="panel-body">
            ...
            <div class="sim-grid" style="grid-template-columns:1fr">
              ...
              <div class="fgroup"><label>Prazo (meses) <span class="sim-tip"><span class="sim-tip-icon">i</span><span class="sim-tip-box">Número de meses para quitar o financiamento. O prazo máximo na CAIXA é de 35 anos (420 meses).</span></span></label><input type="number" id="sim-prazo2" value="360" min="12" step="12"></div>
              <div class="fgroup"><label>Juros (% a.a.) <span class="sim-tip"><span class="sim-tip-icon">i</span><span class="sim-tip-box">Taxa anual aplicada ao financiamento, definida pela CAIXA conforme seu perfil e relacionamento com o banco.</span></span></label><input type="number" id="sim-juros2" value="10.5" min="0" step="0.1"></div>
              <div class="fgroup"><label>Sistema <span class="sim-tip"><span class="sim-tip-icon">i</span><span class="sim-tip-box">PRICE: parcelas fixas, ideal para quem prefere previsibilidade no orçamento. SAC: parcelas que diminuem ao longo do tempo.</span></span></label><select id="sim-sis2"><option value="PRICE">PRICE (parcela fixa)</option><option value="SAC">SAC (decrescente)</option></select></div>
            </div>
